...
from model.model.common.normalizer import LinearNormalizer
from model.policy.base_image_policy import BaseImagePolicy
from model.model.diffusion.conditional_unet1d import ConditionalUnet1D
from model.model.diffusion.mask_generator import LowdimMaskGenerator
from model.model.vision.maniwav_obs_encoder import ManiWAVObsEncoder
from model.utils.pytorch_util import dict_apply


class DiffusionUnetManiWAVPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            noise_scheduler: DDPMScheduler,
            obs_encoder: ManiWAVObsEncoder,
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor], fixed_action_prefix: torch.Tensor=None) -> Dict[str, torch.Tensor]:
        ...
        # nobs['gripper_position'] = torch.unsqueeze(nobs['gripper_position'], dim=-1)
